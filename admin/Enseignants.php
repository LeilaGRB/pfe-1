...
$id = $bdd->prepare('SELECT * FROM ensegniants');
$id->execute();
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <a href="info_infirmier.php?&id_inf=<?= $m['id_inf'] ?>">
      <button class="btn btn-default btn-sm" ><i class="fa fa-ey "></i> Détail</button></a>
      <input type="button" name="edit" value="Modifier" id="<?php echo $m['id_inf']; ?>" class="btn btn-warning btn-sm edit_data" />
